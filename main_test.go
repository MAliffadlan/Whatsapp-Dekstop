...
func TestPrivacyModeCoversArchivedChatsAndAllAvatarVariants(t *testing.T) {
	...
	checks := []string{
		...
		"[data-wa-privacy-archived-row=\"1\"][data-wa-privacy-hover=\"1\"] ._ak8h",
